...
},{"@gerhobbelt/js-yaml":2}],2:[function(require,module,exports){
'use strict';
...
function escapeString(string) {
  ...
  for (var i = 0; i < string.length; i++) {
    char = string.charCodeAt(i);              // Only very recent JS engines support .codePointAt(i) API
